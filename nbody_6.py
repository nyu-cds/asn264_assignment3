"""
    ...
    In this script I modify the loops that look like:
    for body1 in BODIES.keys():
        for body2 in BODIES.keys():
            #etc...

    TIME: 131.398849964 SECONDS

SIXTH MOST IMPROVEMENT
"""
...
def advance(dt):
    ...
    for idx, body1 in enumerate(BODIES.keys()): 
        for body2 in BODIES.keys()[idx+1:]:           
