...
In this script, I explore alternative to membership testing of lists. This can be seen in the functions
report_energy and advance, where I used sets instead of lists for the variable seenit. 

TIME: 127.233494997 SECONDS
