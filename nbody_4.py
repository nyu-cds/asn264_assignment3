...
I use data aggregation to reduce function call overhead by changing the number of times the function 
advanced is called for each value of 'loops'. 

TIME: 129.795898914 SECONDS

FOURTH MOST IMPROVEMENT
"""
