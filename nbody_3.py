...
In this script, I change the global variables BODIES, SOLAR_MASS, DAYS_PER_YEAR, and BODIES
to local variables in the functions advance, report_energy, offset_momentum, and nbody.

TIME: 131.052659988 SECONDS

FIFTH MOST IMPROVEMENT
"""
...
def advance(dt):
    ...
    seenit = []
    for body1 in loc_BODIES.keys():
        for body2 in loc_BODIES.keys():
